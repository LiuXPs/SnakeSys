...
#ifndef THREAD_CALLBACK_H
#define THREAD_CALLBACK_H
...
class ThreadCallback : public QThread {
Q_OBJECT

public:
    explicit ThreadCallback(QObject *parent = nullptr);

    ~ThreadCallback() override;

public:
    void run();
};

#endif // THREAD_CALLBACK_H