...
bool ZedCamera::startPosTracking()
{
  ...
  if (mGnssFusionEnabled && err == sl::ERROR_CODE::SUCCESS) {
    ...
    //params.gnss_initialisation_distance = mGnssInitDistance; // Modified by LiuXupeng.
...
bool ZedCamera::startObjDetect()
{
  ...
  //od_p.image_sync = true; // Modified by LiuXupeng.
...
bool ZedCamera::startBodyTracking()
{
  ...
  //bt_p.image_sync = true; // Modified by LiuXupeng.
...
void ZedCamera::processGeoPose()
{
  ...
  //mGeoPoseStatus = mFusion.getGeoPose(mLastGeoPose); // Modified by LiuXuPeng.
