...
#ifndef DIALOG_ARC_MODE_H
#define DIALOG_ARC_MODE_H
...
class DialogArcMode : public QDialog {
Q_OBJECT

public:
    explicit DialogArcMode(QWidget *parent = nullptr);

    ~DialogArcMode() override;

private:
    std::shared_ptr<Ui::DialogArcMode> ui;
