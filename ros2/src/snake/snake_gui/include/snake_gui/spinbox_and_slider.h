...
#ifndef SPINBOX_AND_SLIDER_H
#define SPINBOX_AND_SLIDER_H
...
public:
    SpinBoxAndSlider(QWidget *parent = nullptr);

    virtual ~SpinBoxAndSlider();

private:
    Ui::SpinBoxAndSlider *ui;
public:
    void initParam(std::string name, int min, int max, int step);
