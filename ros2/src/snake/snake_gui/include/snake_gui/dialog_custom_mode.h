...
#ifndef DIALOG_CUSTOM_MODE_H
#define DIALOG_CUSTOM_MODE_H
...
namespace Ui {
    class DialogCustomMode;
}

class DialogCustomMode : public QDialog {
Q_OBJECT

public:
    explicit DialogCustomMode(QWidget *parent = nullptr);

    ~DialogCustomMode() override;

private:
    std::shared_ptr<Ui::DialogCustomMode> ui;
