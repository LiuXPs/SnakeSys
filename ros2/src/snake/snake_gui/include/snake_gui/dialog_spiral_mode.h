...
#ifndef DIALOG_SPIRAL_MODE_H
#define DIALOG_SPIRAL_MODE_H
...
namespace Ui {
    class DialogSpiralMode;
}

class DialogSpiralMode : public QDialog {
Q_OBJECT

public:
    explicit DialogSpiralMode(QWidget *parent = nullptr);

    ~DialogSpiralMode() override;

private:
    std::shared_ptr<Ui::DialogSpiralMode> ui;
