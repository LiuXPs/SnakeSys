...
#ifndef DIALOG_PARAM_CONTROL_H
#define DIALOG_PARAM_CONTROL_H
...
namespace Ui {
    class DialogParamControl;
}

class DialogParamControl : public QDialog {
Q_OBJECT

public:
    explicit DialogParamControl(QWidget *parent = nullptr);

    ~DialogParamControl() override;

private:
    std::shared_ptr<Ui::DialogParamControl> ui;
