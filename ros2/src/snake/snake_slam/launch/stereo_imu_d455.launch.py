...
def generate_launch_description():
    ...
    settings_file_path = os.path.join(slam_pkg_dir, 'config', 'stereo_imu_d455.yaml')
    ...
    slam_node = Node(
        ...
        remappings=[
            ...
            ('/camera/left/image_raw/compressed', '/camera/infra1/image_rect_raw/compressed'),
            ('/camera/right/image_raw/compressed', '/camera/infra2/image_rect_raw/compressed'),
        ],
        parameters=[{
