...
- Next, copy the `ORBvoc.txt` file from `ORB-SLAM3/Vocabulary/` folder to the `config` folder in this package. Alternatively, you can change the `voc_file_val_` param in the launch file to point to the right location.
...
# Params
- Enable / disable pangolin viewer: `enable_pangolin_val_`
