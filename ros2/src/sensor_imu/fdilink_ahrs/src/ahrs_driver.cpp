...
namespace FDILink {
    ahrsBringup::ahrsBringup()
        ...
        this->declare_parameter<std::string>("imu_frame_id_val_", "gyro_link");
        this->get_parameter("imu_frame_id_val_", imu_frame_id_);
        ...
        // pravite_nh.param("imu_frame", imu_frame_id_val_, std::string("imu"));
